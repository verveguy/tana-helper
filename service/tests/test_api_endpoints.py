...
class TestJsonifyEndpoints:
    ...
    def test_jsonify_endpoint(self, test_client, sample_tana_data):
        ...
        assert response.status_code in [200, 422]  # 422 is acceptable for validation errors
...
class TestAIIntegrationEndpoints:
    ...
    def test_weaviate_query_endpoint_without_api_key(self, test_client):
        ...
        try:
            ...
            if ("proxies" in str(e) or "Client.__init__" in str(e) or 
                "AuthenticationError" in str(e) or "invalid_api_key" in str(e)):
