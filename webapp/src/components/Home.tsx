      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-foreground">
          <p>
            ...
            command. Not only can it make calls to internet services with APIs to fetch data into Tana, 
            you can also pass existing Tana node data to these APIs and then receive results in return. 
            The results of these calls can be added as new Tana nodes or can be used as input to further 
            features like the built-in AI integration.
          </p>
          
          <p>
            This service, <strong>Tana Helper</strong>, is designed to be called from Tana, 
            but it also has a simple web UI for exploring and testing.
          </p>
          
          <p>
            The service can process JSON exports from Tana and then transform the resulting data into 
            various formats. This includes conversion to formats like Mermaid for diagram generation, 
            data structures for visualization, and integration with AI services for analysis.
          </p>
