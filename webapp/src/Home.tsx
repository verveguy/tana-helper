...
export default function Home() {
  ...
  return (
    <div className='home-container'>
      ...
      <Typography variant='body1' align='left' gutterBottom>
        Full documentation and demonstrations of features can be found at <a href="https://tana.pub/EufhKV4ZMH/tana-helper">Tana Helper</a> (Tana pub site). The source code is open source under the MIT License and is available on github at <a href="https://www.github.com/verveguy/tana-helper">verveguy/tana-helper</a>.
      </Typography>
      <Typography variant='h4' align='left' gutterBottom>
        About this web UI
      </Typography>
