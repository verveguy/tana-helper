...
// The following comments allow Raycast to directly load this as a script command

// Required parameters:
// @raycast.schemaVersion 1
// @raycast.title Tana Calendar
...
// Documentation:
// @raycast.description Get Calendar into Tana paste format
// @raycast.author Brett Adam
// @raycast.authorURL https://github.com/verveguy/
...
"""
    ...
    Accepts arguments, many of which should be quoted on the cmd line:
        ...
        -noheader (if present, omits %%tana%% header line)
